\textbf{\textit{Soal.}} \input{Problems/38 Kompetisi Sains Ruangguru 2021 Nomor 1}
\begin{proof}[\textbf{Solusi 1. }] (Tuesday, 17 August 2021) 
    \input{Tikzlatex/38 (2) Kompetisi Sains Ruangguru 2021 Nomor 1}
...
\end{proof}
\begin{proof}[\textbf{Solusi 2. }] (Tuesday, 30 September 2025)
    \input{Tikzlatex/38 (1) Kompetisi Sains Ruangguru 2021 Nomor 1}
    Dari Menelaus pada segitiga $DEC$ dan garis transversal $\overline{AMF}$ didapat
    \begin{align*}
        \dfrac{DM}{ME}\cdot \dfrac{EF}{FC} \cdot \dfrac{CA}{AD} = 1 \implies
        \dfrac{1}{1}\cdot \dfrac{EF}{FC} \cdot \dfrac{2}{1} = 1 \implies
    ...
    Karena $E$ dan $D$ berturut-turut adalah  titik tengah $CB$ dan $CA$, maka $DE \parallel AB$ dan $DE= \frac{1}{2}AB$. 
...
\end{proof}
\begin{proof}[\textbf{Solusi 3. }] (Tuesday, 30 September 2025)
    \input{Tikzlatex/38 Kompetisi Sains Ruangguru 2021 Nomor 1}
    ...
    \begin{align*}
        \dfrac{FC}{BC} = \dfrac{FC}{EC} \cdot \dfrac{EC}{BC} = \dfrac{2}{3} \times \dfrac{1}{2} = \dfrac{1}{3} \implies \dfrac{CF}{FB} = \dfrac{1}{2}.
    \end{align*}
    Dari fakta tersebut dengan Menelaus pada segitiga $ABC$ dan garis transversal $\overline{GDF}$, diperoleh
    \begin{align*}
    ...
    Misalkan $N$ adalah perpotongan $MC$ dengan $AE$. Lalu misalkan $T$ adalah perpotongan $FN$ dengan $AB$. 
...
\end{proof}
\begin{proof}[\textbf{Solusi 4. }] (Wednesday, 1 October 2025, Inspired by Reza Wahyu Kumara's Solution)
    \input{Tikzlatex/38 (1) Kompetisi Sains Ruangguru 2021 Nomor 1}
    Dari Menelaus pada segitiga $DEC$ dan garis transversal $\overline{AMF}$ didapat
    \begin{align*}
        \dfrac{DM}{ME}\cdot \dfrac{EF}{FC} \cdot \dfrac{CA}{AD} = 1 \implies
        \dfrac{1}{1}\cdot \dfrac{EF}{FC} \cdot \dfrac{2}{1} = 1 \implies
        \dfrac{EF}{FC} = \dfrac{1}{2} \implies
        \dfrac{EF}{EC} = \dfrac{1}{3}.
    \end{align*}
    Karena $E$ titik tengah $BC$, maka 
    \begin{align*}
        \dfrac{FC}{BC} = \dfrac{FC}{EC} \cdot \dfrac{EC}{BC} = \dfrac{2}{3} \times \dfrac{1}{2} = \dfrac{1}{3} \implies 
        \dfrac{CF}{FB} = \dfrac{1}{2} \implies
        \dfrac{FC}{BC} = \dfrac{1}{3}.
    \end{align*}
    Dari sini didapat $EF = \frac{1}{3}EC = \frac{1}{3}\times\frac{1}{2}\times BC = \frac{1}{2} FC$.
    Lalu, karena $E$ dan $D$ berturut-turut adalah titik tengah $CB$ dan $CA$, maka $DE \parallel AB$ dan $DE= \frac{1}{2}AB = \frac{1}{2}AC$. 
    Selanjutnya perhatikan bahwa karena $AB=AC$ dan $DE \parallel AB$ maka $\angle DEF = \angle ABC = \angle FCA$. 
    Oleh karena itu, diperoleh fakta bahwa $\triangle DEF \sim \triangle ACF$. 
    Hal ini mengakibatkan $\angle MDF = \angle EDF = \angle FAC = \angle MAD$ yang berarti dengan \textit{alternate segment theorem} diperoleh bahwa $DF$ menyinggung lingkaran luar $\triangle ADM$.
    Terbukti.
