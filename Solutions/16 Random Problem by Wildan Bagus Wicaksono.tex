\textbf{\textit{Soal. }}\input{Problems/16 Random Problem by Wildan Bagus Wicaksono}
...
% \input{Asymptote/16 Random Problem by Wildan Bagus Wicaksono}
\input{Tikzlatex/16 Random Problem by Wildan Bagus Wicaksono}

Berarti dengan \textit{power of a point}
$$RX'\cdot RB = RD\cdot RA = RQ\cdot QS.$$
