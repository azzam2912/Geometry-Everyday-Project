\textbf{\textit{Soal. }}\input{Problems/22 LMNAS SMP 33 Penyisihan nomor 16}
\begin{proof}[\textbf{Solusi. }] (Saturday, 11 November 2023)  Misalkan $S$ pada garis $CP$ sehingga $BS \parallel PQ$. Perhatikan bahwa $\triangle CPQ \sim \triangle CSB$. Misalkan panjang $CR = x$ maka $\dfrac{PS}{CP} = \dfrac{QB}{CQ} = 1 \implies PS=CP=5+x$. Selanjutnya, $\dfrac{SB}{BQ}=\dfrac{CB}{CQ}=2 \implies SB = 2PQ=8$. 
...
yang berarti $CR=\dfrac{7}{5}$ dan $CP=\dfrac{32}{5}$.
    ...
    \input{Asymptote/22 LMNAS SMP 33 Penyisihan nomor 16}
