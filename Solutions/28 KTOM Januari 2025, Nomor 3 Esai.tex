...
\begin{proof}[\textbf{Solusi. }] (Minggu, 26 Januari 2025) 
    ...
    \begin{lemma}
        ...
        \begin{proof}
            Dengan bantuan \ref{lemmaktomjan25-1} dan fakta bahwa $AB \parallel CD$ didapat
            \begin{align*}
    ...
    \begin{lemma}\label{lemmaktomjan25-4}
        $F,O,G,H$ konsiklis.
        \begin{proof}
            Dari \ref{lemmaktomjan25-1} dan Teorema Miquel pada $\triangle DHC$, didapatkan bahwa $O$ adalah Miquel point dari $\triangle DHC$ yang berakibat $F,O,G,H$ konsiklis.
        \end{proof}
    \end{lemma}
    Dari \ref{lemmaktomjan25-1} dan \ref{lemmaktomjan25-4}, didapat $F,A,H,B,G,O$ konsiklis.
