\textbf{\textit{Soal. }} \input{Problems/28 KTOM Januari 2025, Nomor 3 Esai}
\textit{Proposed by: Raymond Christopher Tanto}
\begin{proof}[\textbf{Solusi. }] (Minggu, 26 Januari 2024) 
    \input{Asymptote/28 KTOM Januari 2025, Nomor 3 Esai}    
    ...
    \begin{lemma}\label{lemmaktomjan25-1}
        $A,B,G,O,F$ konsiklis.
        \begin{proof}
    ...
    \begin{lemma}
        ...
        \begin{proof}
            Dengan bantuan \cref{lemmaktomjan25-1} dan fakta bahwa $AB \parallel CD$ didapat
            \begin{align*}
        ...
        \end{proof}
    \end{lemma}
    \begin{lemma}\label{lemmaktomjan25-3}
        ...
        \end{proof}
    \end{lemma}
    \begin{lemma}\label{lemmaktomjan25-4}
        $F,O,G,H$ konsiklis.
        \begin{proof}
            Dari \cref{lemmaktomjan25-1} dan Teorema Miquel pada $\triangle DHC$, didapatkan bahwa $O$ adalah Miquel point dari $\triangle DHC$ yang berakibat $F,O,G,H$ konsiklis.
        \end{proof}
    \end{lemma}
    Dari \cref{lemmaktomjan25-1} dan \cref{lemmaktomjan25-4}, didapat $F,A,H,B,G,O$ konsiklis.
