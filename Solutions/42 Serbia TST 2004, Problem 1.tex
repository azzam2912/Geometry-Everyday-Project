\textbf{\textit{Soal.}} \input{Problems/42 Serbia TST 2004, Problem 1.tex}
...
\input{TikzLatex/42 (1) Serbia TST 2004, Problem 1.tex}
...
Sekarang jelas karena $\dangle AOB = 90^\circ$ maka $O$ dilewati oleh lingkaran $K$. 
\end{proof}
