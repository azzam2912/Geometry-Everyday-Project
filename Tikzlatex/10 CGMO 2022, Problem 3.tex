\begin{center}
    \begin{tikzpicture}[scale=3, dot/.style={circle, fill, inner sep=0.5pt, outer sep=0pt}]
        ...
        \tkzMarkRightAngle[blue, size=0.05](C,I,N)
        \tkzMarkRightAngle[size=0.05](T,M,B)
        \tkzMarkRightAngle[size=0.05](I,D,B)
        \tkzMarkRightAngle[size=0.05](Ia,K,B)

        \tkzDrawPoints[fill=black, size=3](A,B,C,I,M,D,L,J,T,Ia,N,K)
