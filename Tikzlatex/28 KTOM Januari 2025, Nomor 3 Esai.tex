\begin{center}
    \begin{tikzpicture}[scale=5, dot/.style={circle, fill, inner sep=0.5pt, outer sep=0pt}]
        ...
        \tkzMarkRightAngle[size=0.05](B,F,A)
        \tkzMarkRightAngle[size=0.05](A,G,E)
        \tkzMarkRightAngle[size=0.05](C,D,A)
        \tkzMarkRightAngle[size=0.05](B,C,D)
        \tkzMarkRightAngle[red,size=0.05](C,O,D)

        \tkzDrawPoints(A,B,C,D,E,F,G,H,O,T)
