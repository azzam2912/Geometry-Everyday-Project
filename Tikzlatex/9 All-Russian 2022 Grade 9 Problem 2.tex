\begin{center}
    \begin{tikzpicture}[scale=3.2, dot/.style={circle, fill, inner sep=0.5pt, outer sep=0pt}]
        ...
        \tkzMarkRightAngle[size=0.15,green!60!black](Ob,I,C)
        \tkzMarkRightAngle[size=0.15,red](Oc,I,B)
        \tkzMarkRightAngle[size=0.15](M,Mb,B)
        \tkzMarkRightAngle[size=0.15](M,Mc,C)

        % Titik dan label
        \tkzDrawPoints(A,B,C,I,M,J,Mb,Ob,Mc,Oc,K)
