\begin{center}
    \begin{tikzpicture}[scale=4, dot/.style={circle, fill, inner sep=0.5pt, outer sep=0pt}]
        ...
        \tkzMarkRightAngle[size=0.0375](A,Z,Q)
        \tkzMarkRightAngle[size=0.0375](P,X,B)
        \tkzMarkRightAngle[size=0.0375](Q,Y,C)
        \tkzMarkRightAngle[size=0.0375](Op,K,X)
        \tkzMarkRightAngle[size=0.0375](Oq,L,Y)

        \tkzDrawPoints[fill=black, size=3](A,B,C,O,P,Q,X,Y,Z,O1,K,L,M,N,Op,Oq)
